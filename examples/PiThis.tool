...
class Computer {
    ...
    def getTerm(i : Int) : Frac = {
        ...
        return par.times(new Frac().init(1, sixteenPow(i)));
    }
...
class Frac {
    ...
    def times(other : Frac) : Frac = {
        return (new Frac()).init(numerator * other.getNumerator(), denominator * other.getDenominator()).simplify().setPos(isPos() && other.isPos() || !isPos() && !other.isPos());
    }
